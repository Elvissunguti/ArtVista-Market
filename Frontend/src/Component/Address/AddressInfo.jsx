...
const AddressInfo = () => {
    ...
    return (
        <DashBoard>
            <div className="p-4">
                <h1 className="text-3xl font-semibold mb-6 text-main text-center">Account Overview</h1>

                {/* Account Details Section */}
                <div className="mb-8">
                    <h2 className="text-xl font-semibold text-main mb-3">Account Details</h2>
